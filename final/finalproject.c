...
{
    printf("\n******************************************************************************************************************************\n");
    printf("\t\t\t\t\t\t**Welcome to Merchandise Section\n");
    printf("\n******************************************************************************************************************************\n");
...
int Funevent(int a)
{
    ...
    if(age < 18){
        ...
        printf("3. Treasure Hunt (INR 550)\n");
        printf("4. Futsal (INR 450)\n");
        printf("5. Smash Cricket (INR 300)\n");
